    ...
    <div className="flex flex-col w-full sm:mt-[200px] pt-16">
      ...
      {selectedCase?.featured?.map((port) => (
        <div key={port.slug} className="flex flex-col w-full pb-16">
          <Wrapper className="flex flex-col mb-4 sm:!px-[100px] !px-14 pt-20">
          ...
          <Wrapper className="sm:!px-[100px] !px-0">
            <div className="w-full group relative">
              <img
                ...
                alt="dish"
                className="sm:rounded-xl w-full clip-path-triangle h-[350px] md:h-[550px] lg:h-[650px]  object-cover"
              />
