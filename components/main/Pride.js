  ...
  return (
    <div className="flex flex-col w-full sm:mt-[200px] overflow-hidden">
      <Wrapper className="flex flex-col  px-16">
        <p className="text-yellow-550 md:text-xl uppercase text-[15px] tracking-[4.5px] font-bold">
          JAGERMEISTER
        </p>
      ...
      <div className="sm:mt-[150px] mt-16 flex items-center justify-center flex-col sm:gap-8 gap-4 py-4 min-h-[200px]">
        ...
        <Link
          href="/portfolio"
          className="bg-yellow-550 rotate-[2deg] inline-block text-xl sm:text-[29px] text-[#231F20] px-4 sm:py-2 font-bold"
        >
          Boy, we got more
        </Link>
      </div>
